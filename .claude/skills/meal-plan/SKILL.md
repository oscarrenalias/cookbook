...
Meals are always prepared for 5 persons by default unless stated otherwise, since we are a family of 5. Adjust scaling as needed based on the recipe. Consider prep time and complexity when planning weeknight meals.
